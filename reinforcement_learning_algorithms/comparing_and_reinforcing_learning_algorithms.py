...
rewards_q_learning = np.full((grid_size * grid_size,), -1)  # -1 for every state
rewards_q_learning[24] = 10  # Goal state
rewards_q_learning[12] = -10  # Pitfall state
...
for episode in range(1000):
    ...
    while not done:
        ...
        reward = rewards_q_learning[next_state]
